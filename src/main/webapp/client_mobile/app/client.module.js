...
clientModule.config(function($stateProvider,$urlRouterProvider,$locationProvider){
    ...
    $stateProvider
        ...
        .state('root', {
            ...
            views:{
                'header':{
                    templateUrl: 'client_mobile/app/shared/header/header.html',
                    controller: 'headerCtrl as header'
                },
                'footer':{
                    templateUrl: 'client_mobile/app/shared/footer/footer.html',
        ...
        .state('root.index', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/index/index.html',
         ...
         //新建稿件页面
        .state('root.newArticle', {
            url:'/newArticle/',
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/newArticle/new_article.html',
                    controller: 'newArticleCtrl as newArticle'
                }
            }
        })
        ...
        .state('root.photolist', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/photoList/photolist.html',
        ...
        .state('root.moreSortList', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/moreSortList/more_sort_list.html',
        ...
        .state('root.detailList', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/detail/detailList/pics_detail.html',
        ...
        .state('root.photoDetail', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/detail/photoDetail/photo_detail.html'
                    //controller: 'photoListCtrl as photoList'
                }
            }
        })
        ...
        .state('root.newDetailList', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/newDetail/detailList/pics_detail.html',
        ...
        .state('root.newSingleDetail', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/newDetail/singleDetail/single_detail.html',
        ...
        .state('root.specPic', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/specPic/specPic.html',
        ...
        .state('root.oldPic', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/oldPic/oldPic.html',
        ...
        .state('root.acadePic', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/acadePic/acadePic.html',
        ...
        .state('root.personPic', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/personPic/personPic.html',
        ...
        .state('root.personList', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/personPic/personList/personList.html',
        ...
        .state('root.chartList', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/chartList/chart_list.html',
        ...
        .state('root.myInfo', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/myInfo/myInfo.html',
        ...
        .state('root.shoppingCart', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/shoppingCart/shoppingCart.html',
        ...
        .state('root.myOrder', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/myOrder/my_order.html',
        ...
        .state('root.lookPics', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/myOrder/look_pics.html',
        ...
        .state('root.needChannel', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/needChannel/need_channel.html',
        ...
        .state('root.releaseNeed', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/needChannel/release_need.html',
        ...
        .state('root.providePic', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/needChannel/provide_pic.html',
        ...
        .state('root.favorite', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/favorite/favorite.html',
        ...
        .state('root.favoriteDetail', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/favorite/detail.html',
        ...
        .state('root.fashionPic', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/fashionPic/fashionPic.html',
        ...
        .state('root.financePic', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/financePic/financePic.html',
        ...
        .state('root.webInfoView', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/webInfoView/webInfoView.html',
        ...
        .state('root.webInfoAllView', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/webInfoView/webInfoAllView.html',
        ...
        .state('root.siteMsg', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/siteMsg/siteMsg.html',
        ...
        .state('root.topicPlayBack', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/topicPlayback/topic_play_back.html',
        ...
        .state('root.monthDraft', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/monthDraft/month_draft.html',
        ...
        .state('famousLecture', {
            ...
            views:{
                'specCon@':{
                    templateUrl: 'client_mobile/app/components/famousLecture/famous_lecture.html',
        ...
        .state('root.login', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/login/login.html',
        ...
        .state('root.register', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/register/register.html',
        ...
        .state('root.registerStepOne', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/register/register_step_one.html',
        ...
        .state('root.registerStepTwo', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/register/register_step_two.html',
        ...
        .state('root.registerSuccess', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/register/register_success.html',
        ...
        .state('root.forgetPassword', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/forgetPwd/forget_password.html',
        ...
        .state('root.forgetPasswordStepOne', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/forgetPwd/forget_password_step_one.html',
        ...
        .state('root.forgetPasswordStepTwo', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/forgetPwd/forget_password_step_two.html',
        ...
        .state('root.forgetPasswordSuccess', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/forgetPwd/forget_password_success.html',
        ...
        .state('forgetPwd', {
            ...
            views:{
                'specCon@':{
                    templateUrl: 'client_mobile/app/components/forgetPwd/forget_pwd.html',
        ...
        .state('currentDoctor', {
            ...
            views:{
                'specCon@':{
                    templateUrl: 'client_mobile/app/components/currentDoctor/forget_pwd.html',
        ...
        .state('currentDoctorClassify', {
            ...
            views:{
                'specCon@':{
                    templateUrl: 'client_mobile/app/components/currentDoctor/current_doctor_classify.html',
        ...
        .state('root.fullText', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/fullRetrieval/fulltext.html',
        ...
        .state('root.advSearch', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/advSearch/adv_search.html',
        ...
        .state('roots.special', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/special/special.html',
                    controller: 'specialCtrl as special'
                }
            }
        })
        ...
        .state('root.moreContribute', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/special/moreContribute.html',
        ...
        .state('root.ggList', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/notice/ggList.html',
        ...
        .state('root.ggDisplay', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/notice/ggDisplay.html',
        ...
        .state('root.help', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/help/help.html',
        ...
        .state('root.editTips', {
            ...
            views:{
                'main@':{
                    templateUrl: 'client_mobile/app/components/editTips/edit_tips.html',
