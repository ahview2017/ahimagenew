 ...
 */
adminModule.controller('userContributeStatisticsCtrl', function ($scope, $cookies, req, md5, $state, $rootScope) {
    var vm = this;
    //初始化相关配置
    ...
    function getContributorTableData(page,type) {
        var searchUrl = "groupStatistical/groupStatisticalForUserList.do";
        var paramsObj = {
            page: page,
            rows: 10
        };
        ...
        if (vm.roleName) {
            paramsObj['roleName'] = vm.roleName;
        } 
        if(vm.orderByCase){
