clientModule.controller('photographerDetailCtrl',function($scope,$sce,$cookies, req, md5, $state, $rootScope, $stateParams, getFullText, $timeout,jugeGroupPos){
    var vm = this;
	...
	//获取更多分类图片
    function getMoreGroups(callback){
