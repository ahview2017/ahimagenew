...
import com.deepai.photo.common.exception.InternalException;
import com.deepai.photo.common.exception.InvalidArgumentException;
...
public class ObjectValidation {
	...
	private static final Logger log = LoggerFactory.getLogger(ObjectValidation.class);
	...
	private void checkNotNull(Object object, String fieldName) {
		if (object == null) {
			throw new InvalidHttpArgumentException(fieldName+" can not be bull");
		}
	}
